...
public class Window extends JFrame implements ActionListener, IListener
{
	...
	public Window(PropertiesReader reader)
	{
		...
		_tabCtrl.register(TabControllerEvent.TAB_CHANGED, this);
	...
	private void createMenu()
	{
		...
		JMenuItem clearOnConnect = menu.add(ButtonFactory.create(
				ButtonFactory.CLEAR_ON_CONNECT, this));
		menu.add(ButtonFactory.create(ButtonFactory.FILTER, this));
		JMenuItem alwaysOnTop = window.add(ButtonFactory.create(
				ButtonFactory.ALWAYS_ON_TOP, this));
		...
		JMenuItem scrollLock = window.add(ButtonFactory.create(
				ButtonFactory.SCROLL_LOCK, this));
		setJMenuBar(menubar);
	 ...
	 * 
	 * @param evt carrys information to distinguish which button has been invoked
	 */
